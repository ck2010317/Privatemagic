...
async function main() {
  ...
  const fundSig = await anchor.web3.sendAndConfirmTransaction(connection, fundTx, [player1Keypair]);
  console.log(`✅ Funded player 2 with 1 SOL: ${fundSig}\n`);
  ...
  console.log("\n3️⃣ Revealing winner (Player 1 wins)...");
  ...
  try {
    ...
    const winnerTx = await program1.methods
      ...
      .accounts({
        ...
        magicContext: DELEGATION_PROGRAM,
      })
      .rpc();
